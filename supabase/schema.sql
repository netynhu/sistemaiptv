...
select * from (values
  ...
  ('ONE UHD', E'**Compatível com:** TV Box e Celular Android\n\n1. Baixe e abra o app **ONE UHD** na loja de apps do seu dispositivo.\n2. Selecione a opção de login via **Usuário e Senha**.\n3. Preencha os campos:\n   - **Usuário:** (gerado individualmente para cada cliente)\n   - **Senha:** (gerada individualmente para cada cliente)\n4. Confirme e aguarde o carregamento da lista de canais.', 4),
